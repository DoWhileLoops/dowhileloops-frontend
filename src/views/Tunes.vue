<template>
  <v-container
    ...
    <div class="example-container">
      <div class="left">
        <span class="playlist-title">Playlist 1</span>
        <div id="white-player">
          <div class="white-player-top">
            ...
            <div>
              <img src="https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/show-playlist.svg" class="show-playlist"/>
            </div>
          </div>
          ...
          <div id="white-player-playlist-container">
            <div class="white-player-playlist-top">
              ...
              <div>
                <img src="https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/close.svg" class="close-playlist"/>
              </div>
            </div>
            ...
            <div class="white-player-playlist">
              ...
              <div v-for="song in songs" v-bind:key="song.name" class="white-player-playlist-song amplitude-song-container amplitude-play-pause" data-amplitude-song-index="0" data-amplitude-playlist="trip_hop">
...
var songs = [
        {
          "name": "Never Mind All That",
          "artist": doWhileLoops,
          "album": titleAggregation,
          "url": urlRoot + "NeverMindAllThat.mp3",
          "cover_art_url": coverartAggregation
        },
		{
          "name": "Stash Pop's Workshop",
          "artist": doWhileLoops,
          "album": titleAggregation,
          "url": urlRoot + "Stash.mp3",
          "cover_art_url": coverartAggregation
        },
		{
          "name": "The Galway Delay",
          "artist": doWhileLoops,
          "album": titleAggregation,
          "url": urlRoot + "GalwayDelay.mp3",
          "cover_art_url": coverartAggregation
        },
		{
          "name": "Night At The Synthsonian",
          "artist": doWhileLoops,
          "album": titleAggregation,
          "url": urlRoot + "Synthsonian.mp3",
          "cover_art_url": coverartAggregation
        },
		{
          "name": "You Guessed 'Er, Chester",
          "artist": doWhileLoops,
          "album": titleAggregation,
          "url": urlRoot + "YouGuessedErChester.mp3",
          "cover_art_url": coverartAggregation
        },
		{
          "name": "The Contact Page Blues",
          "artist": doWhileLoops,
          "album": titleAggregation,
          "url": urlRoot + "ContactPageBlues.mp3",
          "cover_art_url": coverartAggregation
        },
		{
          "name": "What's So Hard About That",
          "artist": doWhileLoops,
          "album": titleAggregation,
          "url": urlRoot + "WhatsSoHard.mp3",
          "cover_art_url": coverartAggregation
        },
		
        {
          "name": "Spread It On",
          "artist": doWhileLoops,
          "album": titleDelineation,
          "url": urlRoot + "SpreadItOn.mp3",		  
          "cover_art_url": coverartDelineation
        },
		{
          "name": "I Don't Know What To Tell You",
          "artist": doWhileLoops,
          "album": titleDelineation,
          "url": urlRoot + "IDontKnowWhatToTellYou.mp3",		  
          "cover_art_url": coverartDelineation
        },
		
		{
          "name": "Riffus Interruptus",
          "artist": doWhileLoops,
          "album": titleDelineation,
          "url": urlRoot + "RiffusInterruptus.mp3",		  
          "cover_art_url": coverartDelineation
        },
		{
          "name": "Throw The Heat",
        ...
        },
		{
          ...
          "artist": doWhileLoops,
          "album": titleDelineation,
          "url": urlRoot + "YesYouCan.mp3",		  
          "cover_art_url": coverartDelineation
        },
		{
          "name": "That Kid In The Upstairs Apartment Must Weight 500 Pounds",
          "artist": doWhileLoops,
          "album": titleDelineation,
          "url": urlRoot + "ThatKidUpstairs.mp3",		  
          "cover_art_url": coverartDelineation
        },
		{
          "name": "And Also With You",
          "artist": doWhileLoops,
          "album": titleDelineation,
          "url": urlRoot + "AndAlsoWithYou.mp3",		  
          "cover_art_url": coverartDelineation
        },
		{
          "name": "Land Ho",
...
div#white-player-controls {
  ...
  div#white-player-controls div#shuffle {
    ...
    div#white-player-controls div#shuffle.amplitude-shuffle-off {
      background: url("https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/shuffle-off.svg"); }
    div#white-player-controls div#shuffle.amplitude-shuffle-on {
      background: url("https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/shuffle-on.svg"); }
  div#white-player-controls div#previous {
    display: inline-block;
    height: 53px;
    width: 53px;
    cursor: pointer;
    background: url("https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/previous.svg");
    vertical-align: middle;
    margin-right: 16px; }
  div#white-player-controls div#play-pause {
    ...
    div#white-player-controls div#play-pause.amplitude-paused {
      background: url("https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/play.svg"); }
    div#white-player-controls div#play-pause.amplitude-playing {
      background: url("https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/pause.svg"); }
  ...
  div#white-player-controls div#repeat {
    ...
    div#white-player-controls div#repeat.amplitude-repeat-off {
      background: url("https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/repeat-off.svg"); }
    div#white-player-controls div#repeat.amplitude-repeat-on {
      background: url("https://521dimensions.com/img/open-source/amplitudejs/examples/multiple-playlists/repeat-on.svg"); }
